...
const std::unordered_map<std::string, std::string>& MetricDisplayNames() {
    static const std::unordered_map<std::string, std::string> kNames = {
        ...
        {"metadata_allocation_mode", "\u5149\u76d8\u5206\u914d\u6a21\u5f0f"},
        {"metadata_optical_layout", "\u5149\u76d8\u5e03\u5c40\u7248\u672c"},
        {"metadata_optical_layout_version", "\u5149\u76d8\u5e03\u5c40\u7248\u672c"},
        {"metadata_layout_profile", "\u5149\u76d8\u5e03\u5c40\u6a21\u578b"},
        {"metadata_disc_capacity_bytes", "\u5355\u5f20\u5149\u76d8\u5bb9\u91cf\u5b57\u8282"},
        {"metadata_images_per_disc", "\u5355\u5f20\u5149\u76d8\u955c\u50cf\u6570"},
        {"metadata_small_discs_per_node", "\u6bcf\u8282\u70b91TB\u5149\u76d8\u6570"},
        {"metadata_small_disc_capacity_bytes", "1TB\u5149\u76d8\u5bb9\u91cf\u5b57\u8282"},
        {"metadata_small_images_per_disc", "1TB\u5149\u76d8\u955c\u50cf\u6570"},
        {"metadata_large_discs_per_node", "\u6bcf\u8282\u70b910TB\u5149\u76d8\u6570"},
        {"metadata_large_disc_capacity_bytes", "10TB\u5149\u76d8\u5bb9\u91cf\u5b57\u8282"},
        {"metadata_large_images_per_disc", "10TB\u5149\u76d8\u955c\u50cf\u6570"},
        {"metadata_total_disc_count", "\u5143\u6570\u636e\u5149\u76d8\u603b\u6570"},
        {"metadata_total_capacity_bytes", "\u5143\u6570\u636e\u5149\u76d8\u603b\u5bb9\u91cf\u5b57\u8282"},
        {"metadata_used_disc_count", "\u5143\u6570\u636e\u5df2\u4f7f\u7528\u5149\u76d8\u6570"},
        {"metadata_unused_disc_count", "\u5143\u6570\u636e\u672a\u4f7f\u7528\u5149\u76d8\u6570"},
        {"metadata_used_capacity_bytes", "\u5143\u6570\u636e\u5df2\u7528\u5149\u76d8\u5bb9\u91cf\u5b57\u8282"},
        {"metadata_free_capacity_bytes", "\u5143\u6570\u636e\u5269\u4f59\u5149\u76d8\u5bb9\u91cf\u5b57\u8282"},
        {"metadata_cursor_node_index", "\u5149\u76d8\u6e38\u6807\u8282\u70b9\u5e8f\u53f7"},
        {"metadata_cursor_disc_index", "\u5149\u76d8\u6e38\u6807\u5149\u76d8\u5e8f\u53f7"},
        {"metadata_cursor_image_index", "\u5149\u76d8\u6e38\u6807\u955c\u50cf\u5e8f\u53f7"},
        {"metadata_cursor_image_used_bytes", "\u5149\u76d8\u6e38\u6807\u955c\u50cf\u5df2\u7528\u5b57\u8282"},
